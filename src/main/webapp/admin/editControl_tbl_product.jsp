       ...
       <!-- Sidebar Start -->
        ...
        <div class="content">
            ...
            <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%=request.getContextPath()%>/AddProductControl?case=edit" method="post">
                            <input type="hidden" name="msp" value="<%=msp%>"/>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="?" name="ten_san_pham" value="<%=sp.getTen_san_pham()%>">
                                <label for="floatingInput">Tên sản phẩm</label>
                            </div>
                            <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="floatingInput"
                                    placeholder="?" name="hinh_anh" value="<%=sp.getHinh_anh()%>">
                                <label for="floatingInput">Hình ảnh</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingInput"
                                    placeholder="?" name="don_gia" value="<%=sp.getDon_gia()%>">
                                <label for="floatingInput">Mô tả</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="?" name="mo_ta" value="<%=sp.getMo_ta()%>">
                                <label for="floatingInput">Mô tả</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingPassword"
                                    placeholder="?" name="so_luong" value="<%=sp.getSo_luong()%>">
