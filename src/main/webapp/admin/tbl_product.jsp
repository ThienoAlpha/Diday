                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <%for(SanPham sp: SanPhamDao.getListProductByCateGoryForShop()){ %>
                                        <tr>
                                            <th scope="row"><%=sp.getMa_san_pham()%></th>
                                            <td><%=sp.getMa_danh_muc() %></td>
                                            <td><%=sp.getTen_san_pham() %></td>
                                            <td><img src="../<%=sp.getHinh_anh() %>" alt="" style="width:80px;height:80px;"/></td>
                                            <td><%=nf.format(sp.getDon_gia()) %> VNĐ</td>
                                            <td><%=sp.getMo_ta() %></td>
                                            <td><%=sp.getSo_luong() %></td>
                                            <td><a href="addControl_tbl_product.jsp"><button type="button" class="btn btn-primary m-2">Thêm</button></a></td> 
                                            <td><a href="editControl_tbl_product.jsp?msp=<%=sp.getMa_san_pham()%>"><button type="button" class="btn btn-primary m-2">Sửa</button></a></td> 
                                            <td><a href="deleteControl_tbl_product.jsp?msp=<%=sp.getMa_san_pham()%>"><button type="button" class="btn btn-primary m-2">Xóa</button></a></td> 
                                        </tr>
                                       <%
                                      		 }                     
                                       %>
