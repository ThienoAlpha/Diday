                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Mật khẩu mã hóa</th>
                                            <th scope="col">Quyền truy cập</th>
                                            <th scope="col">Tình trạng</th>
                                            <th scope="col">Tên người đăng nhập</th>
                                            <th scope="col">Thêm người dùng</th>
                                            <th scope="col">Sửa thông tin</th>
                                            <th scope="col">Xóa người dùng</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <%for(TaiKhoan tk: taiKhoanDAO.getListUser()){ %>
                                        <tr>
                                            <th scope="row"><%=tk.getMa_tai_khoan() %></th>
                                            <td><%=tk.getTen_tai_khoan() %></td>
                                            <td><%=tk.getMat_khau() %></td>
                                            <td><%=tk.getQuyen_truy_cap() %></td>
                                            <td><%=tk.getTinh_trang() %></td>
                                            <td><%=tk.getTen_nguoi_dang_nhap() %></td>
                                            <td><a href="../login.jsp"><button type="button" class="btn btn-primary m-2">Thêm</button></a></td> 
                                            <td><a href="editControl_tbl_user.jsp?mtk=<%=tk.getMa_tai_khoan()%>"><button type="button" class="btn btn-primary m-2">Sửa</button></a></td> 
                                            <td><a href="deleteControl_tbl_product.jsp?msp="><button type="button" class="btn btn-primary m-2">Xóa</button></a></td> 
                                        </tr>
                                       <%
                                      		 }                     
                                       %>
