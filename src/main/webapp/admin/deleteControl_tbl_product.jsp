...
<div class="container-xxl position-relative bg-white d-flex p-0">
       ...
       <!-- Sidebar Start -->
        ...
        <div class="content">
            ...
            <!-- Table Start -->
            <!--  Viết Confirm form cho nút delete nối vào AddProductControl para delete cho xóa và reset bảng tbl_product.jsp -->
            <div style="margin-top:50px;">
            	<form action="<%= request.getContextPath() %>/AddProductControl?case=delete" method="post">
            	<h3>Bạn có chắc chắn muốn xóa đối tượng này không?</h3>
            	<div style="text-align:center;margin-top:20px;">
            		<input type="hidden" name="msp" value="<%=msp%>"/>
            		<input type="submit" value="Submit" />
            		<a style="margin-left:20px;" href="tbl_product.jsp">Quay lại</a>
            	</div>
            </form>
            </div>  
