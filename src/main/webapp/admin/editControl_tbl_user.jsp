...
<%
	...
	TaiKhoan tk = TaiKhoanDAO.getTaiKhoanByMtk(mtk);
       ...
       <!-- Sidebar Start -->
        ...
        <div class="content">
            ...
            <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<%= request.getContextPath() %>/tbl_User_Control?case=edit" method="post">
                            <input type="hidden" name="mtk" value="<%=mtk%>"/>
                            
                            <div class="form-floating mb-3">
                               <h3> Người dùng: <%=tk.getTen_tai_khoan()%></h3>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput"
                                    placeholder="?" name="mat_khau" value="<%=tk.getMat_khau()%>">
                                <label for="floatingInput">Mật khẩu</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingInput"
                                    placeholder="?" name="quyen_truy_cap" value="<%=tk.getQuyen_truy_cap()%>">
                                <label for="floatingInput">Quyền truy cập</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword"
                                    placeholder="?" name="tinh_trang" value="<%=tk.getTinh_trang()%>" >
                                <label for="floatingPassword">Tình trạng</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword"
                                    placeholder="?" name="ten_nguoi_dang_nhap" value="<%=tk.getTen_nguoi_dang_nhap()%>">
                                <label for="floatingPassword">Tên người đăng nhập</label>
                            </div>
