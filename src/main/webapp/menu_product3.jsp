				...
				<div class="col-sm-9 padding-right">
								...
								<div class="single-products">
									...
									<div class="product-overlay">
										<div class="overlay-content">
											...
											<p><%=sp.getTen_san_pham() %></p>
											<a href="GioHangController?command=insert&ma_san_pham=<%=sp.getMa_san_pham() %>&cartID=<%=System.currentTimeMillis() %>" class="btn btn-default add-to-cart">
					...
					<div class="fix" style="display:flex; justify-content: center;">
						<ul class="pagination">
							...
							<li class="active"><a href="MenuProductController?commandd=trang3">3</a></li>
