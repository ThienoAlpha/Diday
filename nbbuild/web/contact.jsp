				...
				<div class="col-sm-8">
					<div class="contact-form">
						...
						<form id="main-contact-form" class="contact-form row"
							action="<%=request.getContextPath() %>/PhanHoiControl"
							name="contact-form" method="post">
							<div class="form-group col-md-6">
								<input type="text" name="ho_va_ten" class="form-control "
									autocomplete="off" required="required" placeholder="Họ và tên">
							</div>
							<div class="form-group col-md-6">
								<input type="text" name="so_dien_thoai" class="form-control"
									autocomplete="off" required="required" placeholder="SDT">
							</div>
							<div class="form-group col-md-12">
								<input type="text" name="titlle" class="form-control"
									autocomplete="off" required="required" placeholder="Tiêu đề">
							</div>
							<div class="form-group col-md-12">
