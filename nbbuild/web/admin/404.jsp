				...
				<div class="navbar-nav w-100">
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu bg-transparent border-0">
							<a href="admin.jsp" class="dropdown-item">Buttons</a> <a
								href="admin.jsp" class="dropdown-item">Typography</a> <a
								href="admin.jsp" class="dropdown-item">Other Elements</a>
						</div>
					</div>
					<a href="admin.jsp" class="nav-item nav-link"><i
						class="fa fa-th me-2"></i>Widgets</a> <a href="admin.jsp"
						class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Forms</a>
					<a href="admin.jsp" class="nav-item nav-link"><i
						class="fa fa-table me-2"></i>Tables</a> <a href="admin.jsp"
					...
					<div class="nav-item dropdown">
						...
						<div class="dropdown-menu bg-transparent border-0">
							<a href="signin.jsp" class="dropdown-item">Sign In</a> <a
								...
								href="404.jsp" class="dropdown-item active">404 Error</a> <a
								href="admin.jsp" class="dropdown-item">Blank Page</a>
						</div>
					</div>
				</div>
			</nav>
