					...
					<div class="product-details">
						...
						<div class="col-sm-7">
							<div class="product-information">
								...
								<p>
									Mã sản phẩm :<%=request.getParameter("ma_san_pham") %>
								</p>

								<img src="images/product-details/rating.png" alt="" /> <span>
									<span><%=nf.format(sp.getDon_gia()) %>VNĐ</span> <label>Số
										lượng:</label> <input type="text" value="3" name="sluong" /> <a
									href="GioHangController?command=insert&ma_san_pham=<%=sp.getMa_san_pham()%>&cartID=<%=System.currentTimeMillis() %>"><button
