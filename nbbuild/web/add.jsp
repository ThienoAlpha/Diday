...
%>
	...
	<div align="center" style="padding-bottom: 40px;">
		...
		<p>
			100002: Nokia<br>100003: Samsung<br>100004: LG<br>100006:
			Lap Asus<br>100007: Lap HP<br>Số lượng trong kho:
			<%=sanDaoImpl.getSoLuongSanPham().size() %>
		</p>

		<form action="<%= request.getContextPath() %>/AddProductControl"
			method="post">
			<table style="with: 80%">
				<tr>
					<td>Loại hàng</td>
